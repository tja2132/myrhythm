...
tasks = [{:sequence => 1, :routine => Routine.find_by_title("Evening Workout"), :title => 'Bench press', :description => "5x5rep bench press", duration: 8, url: "https://a.co/d/9loFjbD"},
         {:sequence => 2, :routine => Routine.find_by_title("Evening Workout"), :title => 'Bicep curls', :description => "3x12reps standing bicep curls", duration: 4, url: "https://a.co/d/8ukcGlx"},
         {:sequence => 3, :routine => Routine.find_by_title("Evening Workout"), :title => 'Treadmill', :description => "30 minute treadmill", duration: 30, url: "https://a.co/d/1vGoeK1"},
