...
class RoutinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create routine" do
    assert_difference("Routine.count") do
      post routines_url, params: { routine: { created: @routine.created, description: @routine.description, title: @routine.title, updated: @routine.updated } }
    end
  ...
  test "should update routine" do
    patch routine_url(@routine), params: { routine: { created: @routine.created, description: @routine.description, title: @routine.title, updated: @routine.updated } }
